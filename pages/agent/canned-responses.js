...
import { Plus, Search as SearchIcon, Edit, Trash2, X, Loader2, Globe, Lock, FileText } from 'lucide-react';
...
function AgentCannedResponsesPage() {
  ...
  return (
    <>
      ...
      <AgentLayout currentPage="Canned Responses">
...
export default AgentCannedResponsesPage;
