...
export default function NewSLAPolicy() {
  ...
  const [formData, setFormData] = useState({
    ...
    lowResponseTime: 480,      // 8 hours
    mediumResponseTime: 240,   // 4 hours
    highResponseTime: 60,      // 1 hour
    urgentResponseTime: 15,    // 15 minutes
    
    // Resolution times (in minutes)
    lowResolutionTime: 2880,   // 48 hours
    mediumResolutionTime: 1440, // 24 hours
    highResolutionTime: 480,   // 8 hours
    urgentResolutionTime: 240, // 4 hours
    ...
    departmentIds: null, // null = all departments, [] = specific departments
  });
  ...
  const convertDisplayToMinutes = (hours, minutes) => {
    return parseInt(hours) * 60 + parseInt(minutes);
  };

  return (
    <>
      <PageHead title="Create SLA Policy" description="Define response and resolution time targets for different priority levels" />
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 dark:text-slate-100">Create SLA Policy</h1>
