 ...
 */
export async function agentWelcomeTemplate({ agentName, agentEmail, agentId, departmentName, roleName, loginLink, adminName }) {
  const content = `
    <div class="greeting">
    ...
    ${loginLink ? `
      <div style="text-align: center;">
        <a href="${loginLink}" class="button">Access Agent Portal</a>
      </div>
    ` : ''}
    
    <p style="font-size: 14px; color: #64748b; margin-top: 32px; padding-top: 24px; border-top: 1px solid #e2e8f0;">
      <strong>Next Steps:</strong> You can now log in to the agent portal to start managing support tickets. If you have any questions or need assistance, please contact your administrator.
    </p>
