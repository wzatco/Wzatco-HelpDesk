...
export default function AdminLayout({ children }) {
  ...
  const navigation = [
    ...
    { 
      ...
      current: router.pathname.startsWith('/admin/widgets')
    },
    { 
      name: 'Settings', 
      href: '/admin/settings', 
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-xl transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 lg:z-auto ${
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-500 truncate">admin@helpdesk.com</p>
              </div>
